...
class ExceptionDialog extends React.Component {
    constructor(props) {
        super(props);
                        ...
                        <form className="form-inline" style={{marginLeft: '30px'}}>
                            <div className="row">
                                <div className="form-group">
                                    <label style={{paddingRight: '10px'}}>确定将案件置为暂停催收状态?</label>
                                </div>
                            </div>
                        </form>
                    </Modal.Body>
...
module.exports = ExceptionDialog;
