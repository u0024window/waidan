...
module.exports = wrap(function * (req, res, next) {
    var History = React.createFactory(require('views/debt/history-upload/index.entry.jsx'));
    var reactOutput = [];
    ...
    reactOutput.push(ReactServer.renderToString(History({listData: _.get(result, 'data.debtUploadList', [])})));
    res.render('debt/history-upload/index', {
        common: {
            userName: userName
        },
