...
module.exports = wrap(function * (req, res, next) {
    var History = React.createFactory(require('views/debt/history-commission/index.entry.jsx'));
    var reactOutput = [];
    ...
    reactOutput.push(ReactServer.renderToString(History({listData: _.get(result, 'data.commissionList',[])})));
    res.render('debt/history-commission/index', {
        common: {
            userName: userName
        },
